...
from .views import SendVerificationCodeView, VerifyCodeAndRegisterView, CustomTokenObtainPairView, RegisterDeviceView, MediaFileUploadView
...
urlpatterns = [
    ...
    path('upload-media/', MediaFileUploadView.as_view(), name='upload-media'),
]